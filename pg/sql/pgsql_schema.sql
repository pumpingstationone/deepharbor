...
INSERT INTO roles (id, name, permission) OVERRIDING SYSTEM VALUE VALUES (5, 'SuperAdmin', '{"view": ["member.identity", "member.status", "member.roles", "member.forms", "member.connections", "member.extras", "member.authorizations", "member.notes", "member.access", "member.entry", "space.access_logs", "systems.roles", "systems.assign_roles", "systems.api_clients"], "change": ["member.identity", "member.status", "member.roles", "member.forms", "member.connections", "member.extras", "member.authorizations", "member.notes", "member.access", "systems.roles", "systems.assign_roles", "systems.api_clients"]}');
