...
INSERT INTO roles (id, name, permission) OVERRIDING SYSTEM VALUE VALUES (2, 'Administrator', '{"view": ["member.identity", "member.status", "member.roles", "member.forms", "member.connections", "member.extras", "member.authorizations", "member.notes", "member.access", "member.entry", "space.access_logs", "systems.roles", "systems.assign_roles", "systems.api_clients"], "change": ["member.identity", "member.status", "member.roles", "member.forms", "member.connections", "member.extras", "member.authorizations", "member.notes", "member.access", "systems.roles", "systems.assign_roles", "systems.api_clients"]}');
INSERT INTO roles (id, name, permission) OVERRIDING SYSTEM VALUE VALUES (3, 'Board', '{"view": ["member.identity", "member.status", "member.roles", "member.forms", "member.connections", "member.extras", "member.authorizations", "member.notes", "member.access", "member.entry", "space.access_logs", "systems.roles", "systems.assign_roles"], "change": ["member.identity", "member.status", "member.roles", "member.forms", "member.connections", "member.extras", "member.authorizations", "member.notes", "member.access", "systems.roles", "systems.assign_roles"]}');
INSERT INTO roles (id, name, permission) OVERRIDING SYSTEM VALUE VALUES (4, 'ID Check', '{"view": ["member.identity", "member.status", "member.forms", "member.notes", "member.access", "member.connections"], "change": ["member.identity", "member.status", "member.forms", "member.notes", "member.access"]}');
INSERT INTO roles (id, name, permission) OVERRIDING SYSTEM VALUE VALUES (5, 'CTO', '{"view": ["member.identity", "member.status", "member.roles", "member.forms", "member.connections", "member.extras", "member.authorizations", "member.notes", "member.access", "member.entry", "space.access_logs", "systems.roles", "systems.assign_roles", "systems.api_clients"], "change": ["member.identity", "member.status", "member.roles", "member.forms", "member.connections", "member.extras", "member.authorizations", "member.notes", "member.access", "systems.roles", "systems.assign_roles", "systems.api_clients"]}');
INSERT INTO roles (id, name, permission) OVERRIDING SYSTEM VALUE VALUES (6, 'Treasurer', '{"view": ["member.identity", "member.status", "member.roles"], "change": ["member.identity", "member.status", "member.roles"]}');
INSERT INTO roles (id, name, permission) OVERRIDING SYSTEM VALUE VALUES (7, 'Area Host', '{"view": ["member.identity", "member.status", "member.forms", "member.notes", "member.authorizations", "member.connections", "member.extras", "member.roles"], "change": ["member.status", "member.forms", "member.notes", "member.authorizations"]}');
