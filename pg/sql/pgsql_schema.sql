...
INSERT INTO roles (id, name, permission) OVERRIDING SYSTEM VALUE VALUES (4, 'ID Check', '{"view": ["member.identity", "member.status", "member.forms", "member.notes", "member.access", "member.connections"], "change": ["member.status", "member.forms", "member.notes", "member.access"]}');
